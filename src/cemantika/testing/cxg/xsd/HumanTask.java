 ...
 *         &lt;element ref="{http://drools.org/drools-5.0/process}work"/>
...
@XmlType(name = "", propOrder = {
    "metaDataOrWorkOrMapping"
})
@XmlRootElement(name = "humanTask")
public class HumanTask {
    ...
    protected List<Object> metaDataOrWorkOrMapping;
    ...
    /**
     * Gets the value of the metaDataOrWorkOrMapping property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the metaDataOrWorkOrMapping property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMetaDataOrWorkOrMapping().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getMetaDataOrWorkOrMapping() {
        if (metaDataOrWorkOrMapping == null) {
            metaDataOrWorkOrMapping = new ArrayList<Object>();
        }
        return this.metaDataOrWorkOrMapping;
    }
